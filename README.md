...
- Install dj_database_url with pip3 install
- Install physcoog2 -binary with pip3 install
- Use pip3 freeze > requirements.txt to save all your requirements.txt
- got to settings.p and import dj_database_url.
